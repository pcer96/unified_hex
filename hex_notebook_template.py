...
# Install plotly with version compatible with bsp_data_analysis
# Try different versions if this doesn't work - the bsp package in Hex might be older
! uv pip install -q "plotly==5.15.0" pandas-gbq matplotlib
